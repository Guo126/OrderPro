    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: '个人主页', icon: 'dashboard', affix: true }
      }
    ]
  },
...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/man-manegment/index'),
        name: 'IndexMan',
        meta: {
          title: '人员信息',
...

  {
    ...
    children: [
      ...
      {
        path: 'rule',
        component: () => import('@/views/process-manegement/rule'),
        name: 'NumManegment',
        meta: {
          title: '营业厅规则',
          roles: ['admin']  // or you can only set roles in sub nav
